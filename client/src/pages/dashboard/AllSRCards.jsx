...
const AllSRCards = () => {
  ...
  const { data: runningCustomer } = useGetCustomerQuery({
    path: "running",
    showRoom,
  });
  const { data: seizedCustomer } = useGetCustomerQuery({
    path: "seized",
    showRoom,
  });
  ...
  return (
    <>
      ...
      <div className="flex items-center p-4 bg-white rounded">
        ...
        <div className="flex-grow flex flex-col ml-4">
          <span className="text-xl font-bold">
            {seizedCustomer?.data ? seizedCustomer?.data?.length : "-"}
          </span>
          <div className="flex items-center justify-between">
            <span className="text-gray-500">Seized Customer</span>
            <span className="text-red-500 text-md font-semibold ml-2">
              <Link to="/customer/running">
                {" "}
                <i className="pi pi-arrow-right"></i>
