...
const PrivateRoute = ({ children }) => {
  ...
  useEffect(() => {
    if (email && !isUpdated && location.pathname !== "/auth/signin") {
      Swal.fire({
        title: "<strong>নোটিশ</strong>",
        icon: "error",
        html: `আপনার প্রোফাইল একটিভ নেই, একটিভ করতে আপনার হেড অফিসে 
        <div className="message" >
                      <a
                      href="https:api.whatsapp.com/send?phone=8801907093959&text=Need to Acive my Account." autofocus
